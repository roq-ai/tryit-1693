...
import { FiMail, FiUsers, FiMenu, FiUser, FiMessageCircle, FiFile, FiBox, FiCalendar } from 'react-icons/fi';
...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const MockedLinkItems: Array<NavItemPropsInterface> = [
    ...
    { name: 'Prompts', path: '/prompts', entity: 'prompt', service: AccessServiceEnum.PROJECT, icon: FiMessageCircle },
    {
      name: 'Subscriptions',
      path: '/subscriptions',
      entity: 'subscription',
